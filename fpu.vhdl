...
begin
    ...
    begin
        ...
        -- Illegal instructions don't actually come here, they get caught in
        -- decode1 and decode2, so this is here mainly to ensure the state
        -- machine doesn't get stuck if there is a bug and we get an
        -- instruction we don't recognize.
        if illegal = '1' then
            v.instr_done := '1';
            v.state := IDLE;
        end if;
