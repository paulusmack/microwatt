...
const char *ops[128] =
{
	...
	"extswsl", "fpcmp  ", "fptdiv ", "fptsqrt", "mcrfs  ", "mtfsb  ", "mtfsfi ", "mtfsf  ",
	"mffs   ", "fpmrg  ", "fpmr   ", "fpri   ", "fprsp  ", "fpcti  ", "fpctiz ", "fpcfi  ",
	"fpsel  ", "fpadd  ", "fpmul  ", "fpdiv  ", "fpsqrt ", "fpre   ", "fprse  ", "fpmadd ",
	"icbi   ", "icbt   ", "isel   ", "isync  ", "ld     ", "st     ", "mcrxrx ", "mfcr   ",
	"mfmsr  ", "mfspr  ", "mod    ", "mtcrf  ", "mtmsr  ", "mtspr  ", "mull64 ", "mulh64 ",
	...
	"vcntzb ", "vextr  ", "mfvscr ", "mtvscr ", "lvs    ", "xperm  ", "xor    ", "bcd    ",
	"addg6s ", "setz   ", "ffail  ", "?115   ", "?116   ", "?117   ", "?118   ", "?119   ",
